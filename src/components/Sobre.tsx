  ...
  return (
    <section id="sobre" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 max-w-3xl space-y-6 text-papel-quente/85">
        ...
        <p>
          Um exemplo direto: o sistema de gestão de demandas que desenvolvi hoje é usado por mais de
          90% dos 400+ colaboradores da empresa, com mais de 17.900 demandas registradas — eliminando
          a dispersão de comunicação e trazendo métricas reais de acompanhamento.
        </p>
        <p>
